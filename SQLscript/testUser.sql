...
INSERT INTO [User] (UID, userName, fullName, phone, email, password, role, expiredDate, Status, signupDate, MID, gender)
VALUES ('user456', 'regularuser', 'Jane Doe', '0987654321', 'jane@example.com', 'password456', 'member', '2023-12-31', 'active', GETDATE(), 'M456', 'Female');
INSERT INTO [User] (UID, userName, fullName, phone, email, password, role, expiredDate, Status, signupDate, MID, gender)
VALUES ('user', 'duc', 'dr', '0987654321', 'dr@example.com', '1', 'member', '2023-12-31', 'unactive', GETDATE(), 'M456', 'male');
SELECT * FROM [User] 
