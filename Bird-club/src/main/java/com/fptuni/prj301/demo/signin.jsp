                    ...
                    <div class="mx-auto w-full max-w-md sm:px-4 md:w-96 md:max-w-sm md:px-0">
                        <div class="flex flex-col">
                            ...
                            <p class="mt-2 text-sm text-gray-700">
                                Don't have an account? <a class="font-medium text-teal-600 hover:underline" href="signup.jsp">Sign up</a> for a free account.
                            </p>
                        </div>

                        <form class="mt-10 grid grid-cols-1 gap-y-8" id="new_member" data-turbo="false" action="member_homepage.html"  accept-charset="UTF-8" method="post"><input type="hidden" name="authenticity_token" value="ZqSpHCen09U1xp88ejHGAmjetpW4WTyfFlsdhvzWQ9SCEG6ze3LJoPirgRm8L4mWkfuN0u4kc43hS_LaGmd5Zw" autocomplete="off">
