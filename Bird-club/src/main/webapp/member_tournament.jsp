            ...
            <article id="article" class="post-1229 page type-page status-publish has-post-thumbnail hentry">
                <header id="hero-wrapper" aria-label="Banner">
                    <div id="hero-content-container" class="hero-container mobile-stack">
                        <div class="hero-text">
                            <h1>Vietnam's Golden Voice 2023</h1>
                            <p>Our Tournament is filled with exhibits, nestled within a 230-acre sanctuary with 4 km of trails for exploring.</p>        
                        </div>
                    </div>
                    <div><img src="images/tournament.jpg"></div>     
                </header> 
                        ...
                        <div class="is-layout-flex wp-container-7 wp-block-columns three-column-section">
                            <div class="is-layout-flow wp-block-column">
                                ...
                                <div class="is-horizontal is-content-justification-center is-layout-flex wp-container-1 wp-block-buttons">
                                    <div class="wp-block-button"><a class="wp-block-button__link wp-element-button" href="">Sign up now!</a></div>
                                </div>
                            </div>
            ...
            <div class="grid-container">
                ...
                <div class="footer-menu hide-for-print">
                    <nav aria-label="Site map">
                        <ul id="footer-nav" class="menu"><li id="menu-item-1223" class="footer-menu-header menu-item menu-item-type-post_type menu-item-object-page current-menu-ancestor current-menu-parent current_page_parent current_page_ancestor menu-item-has-children menu-item-1223 active"><a href="https://www.birds.cornell.edu/home/about/">About</a>
                                <ul class="sub-menu">
                                    ...
                                    <li id="menu-item-1231" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-1229 current_page_item menu-item-1231 active"><a href="https://www.birds.cornell.edu/home/visit/" aria-current="page">Visit Us</a></li>
                            ...
                            <li id="menu-item-1262" class="footer-menu-header menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-1262 active"><a href="https://www.birds.cornell.edu/home/get-involved/">Quick Finders</a>
                                <ul class="sub-menu">
                                    ...
                                    <li id="menu-item-3237" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-1229 current_page_item menu-item-3237 active"><a href="https://www.birds.cornell.edu/home/visit/" aria-current="page">Visitors</a></li>
